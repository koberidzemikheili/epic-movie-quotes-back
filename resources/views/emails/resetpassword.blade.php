...
<body style="margin: 0; padding: 0; background-color: #11101a;">
    <div style="max-width: 600px; margin: 0 auto; text-align: left; padding: 20px;">
        ...
        <div style="text-align: left;">
            <h1 style="font-size: 2em; font-weight: 900; margin: 0; color: #ffffff;">Hola</h1>
            <p style="margin: 10px 0 0; color: #ffffff;">Thanks for joining Movie quotes! We really appreciate it.</p>
            <p style="margin: 10px 0 0; color: #ffffff;">Please click the button below to reset your password:</p>
            <a href="{{ $resetUrl }}"
                style="background-color: #ff0000; color: #ffffff; display: inline-block; padding: 10px 20px; text-decoration: none; margin-top: 10px; border-radius: 5px;">Reset
                Password</a>
